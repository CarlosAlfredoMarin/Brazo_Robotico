...
La Figura muestra la posición alcanzada por el segundo eslabón del robot cuando la entrada de posición es $\pi/2$, donde el origen angular es sobre el eje vertical, es decir en $90^o$.
